      ...
      <View style={Styles.innerView}>
        ...
        <View>
          <Text
            ...
            {Helper.translation(
              'OfferAccept.How and when do you most want to be reached?',
              'How and when do you most want to be reached?',
            )}
          </Text>
          <View>
            <Checkbox
    ...
    return (
      <View style={{padding: Matrics.ScaleValue(10)}}>
        {data && data.has_voucher_amount ? (
          <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
            <View
              ...
              <HTMLView value={data.voucher_description} stylesheet={styles} />
            </View>
            <View>
              <Image
        ...
        <View
          ...
          {data.social &&
            _.map(_.keys(data.social), (res, index) => (
              <TouchableOpacity
                style={{
                  padding: Matrics.ScaleValue(10),
                  flexDirection: 'row',
                ...
                key={`${index.toString()}`}>
                <Icon
                  name={this.fetchIconName(data.social, res)}
                  type={this.fetchIconType(data.social, res)}
                  color={_.get(data.social[res], 'color', Color.black30)}
                  size={this.fetchIconSize(data.social, res)}
                />
                <Text
                  style={{
          ...
          <KeyboardAvoidingView
            ...
            <ScrollView keyboardShouldPersistTaps={'handled'}>
              {!contactPreferences
                ...
                : null}
              {contactPreferences && sharableData
                ? this.sharePreferencesView(sharableData)
                : null}
            </ScrollView>
          </KeyboardAvoidingView>
        </View>

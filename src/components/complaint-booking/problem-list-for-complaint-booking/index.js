...
export const ProblemListForComplaintBooking = React.memo(
  ({
    item,
    visible,
    selectedProblems,
    ...
    const [problemComplaint, getProblemComplaint] = useState();
    ...
    const ListCompoent = (item, index) => {
      return (
        <TouchableOpacity
          ...
          <Text style={styles.listViewText}>{item.CodeDesc}</Text>
      ...
      <>
        <Modal
          ...
          <View style={{marginTop: 5, flex: 1}}>
            ...
            <View style={{flex: 1}}>
              <FlatList
                data={_.uniqBy(problemComplaint, 'ID')}
